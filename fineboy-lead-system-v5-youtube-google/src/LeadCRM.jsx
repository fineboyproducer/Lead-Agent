...
const PLATFORMS = ["YouTube", "Google", "Twitter/X", "Instagram", "TikTok", "Discord", "Other"];
...
function AddLeadForm({ leads, onAdd, onClose }) {
  const [form, setForm] = useState({ handle: "", platform: "YouTube", source: "", heat: "WARM", threadUrl: "", draftedReply: "", notes: "", email: "" });
